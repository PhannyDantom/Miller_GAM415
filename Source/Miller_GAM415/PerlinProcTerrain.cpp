...
void APerlinProcTerrain::AlterMesh(FVector impactPoint) // Alters Terrain When Hit w/ Projectile
{
...
void APerlinProcTerrain::CreateVertices() //Generates Vertices to Build Triangles
{
...
void APerlinProcTerrain::CreateTriangles() //Randomly Generates Triangles w/i Terrain
{
	int Vertex = 0;
